# Generated by Django 5.0 on 2024-12-21 17:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proyect', '0028_category_attribute'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_user', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='proyect_item_creation_set', to=settings.AUTH_USER_MODEL)),
                ('modification_user', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='proyect_item_modification_set', to=settings.AUTH_USER_MODEL)),
