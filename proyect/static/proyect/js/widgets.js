    ...
    init: function () {
        var e, t, a, o, s, r, i, l, n, c, d, h; !
                    ...
                    new ApexCharts(e, {
                        ...
                        xaxis: {
                            ...
                            crosshairs: {
                                show: !1,
                                position: "front",
                                troke: { color: "#E4E6EF", width: 1, dashArray: 3 }
                            },
                            tooltip: {
                                enabled: !0,
                                formatter: void 0,
            ...
            a && new ApexCharts(a, {
                ...
                colors: [i, l], grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } }
            }).render(),
                    ...
                    function (o) {
                        e = o.getAttribute("data-kt-color"),
                            ...
                            new ApexCharts(o, {
                                ...
                                tooltip: {
                                    style: { fontSize: "12px" },
                                    y: { formatter: function (e) { return "$" + e + " revenue" } }
                                },
                                colors: [a, i], grid: {
                                    padding: { top: 10 },
                                    borderColor: r,
                                    strokeDashArray: 4, yaxis: { lines: { show: !0 } }
                                }
                            }).render()
                    }))
            }(),
